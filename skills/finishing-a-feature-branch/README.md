...
Foundation skill. Verify tests in a worktree, run user-chosen disposition (PR / merge / keep / discard), clean up.

## What it does

Verify tests in a worktree, run user-chosen disposition (PR / merge / keep / discard), clean up.
...
v0 (scaffold, foundation, finishing-a-feature-branch)
