 ...
 *
 * Bootstrap loader for the hhbp SessionStart hook.
 *
 ...
 *   2. Resolves the hhbp plugin root directory (via CLAUDE_PLUGIN_ROOT env var
...
/**
 * Returns true when `candidate` looks like a valid hhbp plugin root, i.e. the
...
/**
 * Resolves the hhbp plugin root using the following priority order:
 ...
 *   4. Versioned cache directories under ~/.claude/plugins/cache/{hhbp}/
...
function resolvePluginRoot() {
  ...
  // Walk versioned cache: ~/.claude/plugins/cache/{hhbp}/<org>/<version>/
  try {
